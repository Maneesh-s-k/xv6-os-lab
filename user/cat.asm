...
cat(int fd)
{
  ...
  6e:	8fe58593          	addi	a1,a1,-1794 # 968 <malloc+0x118>
  72:	4509                	li	a0,2
  74:	6fa000ef          	jal	76e <fprintf>
    exit(1);
  78:	4505                	li	a0,1
...
main(int argc, char *argv[])
{
  ...
  e6:	89e58593          	addi	a1,a1,-1890 # 980 <malloc+0x130>
  ea:	4509                	li	a0,2
  ec:	682000ef          	jal	76e <fprintf>
      exit(1);
  f0:	4505                	li	a0,1
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 464:	0605cf63          	bltz	a1,4e2 <printint+0x90>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
 ...
 478:	52c80813          	addi	a6,a6,1324 # 9a0 <digits>
 47c:	88be                	mv	a7,a5
 ...
 49e:	fcc77fe3          	bgeu	a4,a2,47c <printint+0x2a>
  if(neg)
 4a2:	000e0c63          	beqz	t3,4ba <printint+0x68>
    buf[i++] = '-';
 4a6:	fd050793          	addi	a5,a0,-48
 4aa:	00878533          	add	a0,a5,s0
 4ae:	02d00793          	li	a5,45
 4b2:	fef50423          	sb	a5,-24(a0)
 ...
 4c6:	854a                	mv	a0,s2
 4c8:	f6dff0ef          	jal	434 <putc>
  while(--i >= 0)
 4cc:	39fd                	addiw	s3,s3,-1
 4ce:	14fd                	addi	s1,s1,-1
 4d0:	fe09d9e3          	bgez	s3,4c2 <printint+0x70>
}
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5e0:	855a                	mv	a0,s6
 5e2:	e53ff0ef          	jal	434 <putc>
        putc(fd, c0);
 5e6:	85a6                	mv	a1,s1
 5e8:	855a                	mv	a0,s6
 5ea:	e4bff0ef          	jal	434 <putc>
      state = 0;
 5ee:	4981                	li	s3,0
 ...
 744:	25848493          	addi	s1,s1,600 # 998 <malloc+0x148>
        for(; *s; s++)
